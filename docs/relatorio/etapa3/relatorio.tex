...
A Equação do Calor foi discretizada utilizando o Método das Diferenças Finitas (FDM) com esquema explícito no tempo. Foram implementados três dimensões:
\begin{itemize}
...
\end{itemize}
Cada configuração foi executada 30 vezes (`REPLICACOES = 30`) para garantir significância estatística e permitir a análise de variabilidade.
