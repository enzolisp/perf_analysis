...
\end{itemize}
Cada configuração foi executada 30 vezes (`REPLICACOES = 30`) para garantir significância estatística e permitir a análise de variabilidade\cite{SMPE-01}\cite{Perf-01}.
...
Os resultados indicam uma diferença expressiva de desempenho. A Figura \ref{fig:estabilidade_2d} apresenta a distribuição do tempo de execução para as três dimensões.
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        % Note o ../../../ antes de graphs (3 níveis)
        \includegraphics[width=\textwidth]{../../../graphs/control_charts/control_chart_julia_low_2d.pdf}
        \caption{Julia - Low}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/control_charts/control_chart_julia_mid_2d.pdf}
        \caption{Julia - Mid}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/control_charts/control_chart_julia_high_2d.pdf}
        \caption{Julia - High}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/control_charts/control_chart_python_low_2d.pdf}
        \caption{Python - Low}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/control_charts/control_chart_python_mid_2d.pdf}
        \caption{Python - Mid}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/control_charts/control_chart_python_high_2d.pdf}
        \caption{Python - High}
    \end{subfigure}
    
    \caption{Gráficos de Estabilidade para a dimensão 2D. A linha superior apresenta os resultados para Julia e a inferior para Python. Embora apresentados apenas os dados de 2D, o comportamento de estabilidade mostram o controle do experimento e a diferença da ordem de grandeza do tempo entre Julia e python. Graficos similares para 1d e 2d podem ser encontrados nos anexos. }
    \label{fig:estabilidade_2d}
\end{figure}
...
\begin{figure}[h]
    \centering
    % --- Linha 1: Julia (1D, 2D, 3D) ---
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/linear_regression_texec/linear_regression_texec_julia_1d.pdf}
        \caption{Julia 1D}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/linear_regression_texec/linear_regression_texec_julia_2d.pdf}
        \caption{Julia 2D}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/linear_regression_texec/linear_regression_texec_julia_3d.pdf}
        \caption{Julia 3D}
    \end{subfigure}
    
    \vspace{0.3cm} % Espaço vertical entre as linhas
    
    % --- Linha 2: Python (1D, 2D, 3D) ---
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/linear_regression_texec/linear_regression_texec_python_1d.pdf}
        \caption{Python 1D}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/linear_regression_texec/linear_regression_texec_python_2d.pdf}
        \caption{Python 2D}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/linear_regression_texec/linear_regression_texec_python_3d.pdf}
        \caption{Python 3D}
    \end{subfigure}
    
    \caption{Regressão Linear do Tempo de Execução ($t_{exec}$) versus Tamanho do Problema ($L$).\%.}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/boxplots_mem/boxplot_mem_1d.pdf}
        \caption{Dimensão 1D}
    \end{subfigure}
    \hfill
    % --- 2D ---
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/boxplots_mem/boxplot_mem_2d.pdf}
        \caption{Dimensão 2D}
    \end{subfigure}
    \hfill
    % --- 3D ---
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../../../graphs/boxplots_mem/boxplot_mem_3d.pdf}
        \caption{Dimensão 3D}
    \end{subfigure}
    
    \caption{Comparação do consumo de memória entre Python e Julia. Observa-se que, em todas as dimensões, a alocação de memória do Julia é superior, refletindo o custo do JIT e da gestão de tipos.}
    \label{fig:memoria}
\end{figure}
