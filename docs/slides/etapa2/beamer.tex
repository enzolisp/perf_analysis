...
\frame{
    ...
    \begin{itemize}
        \item Com os dados obtidos foram feitos gráficos.
        \item 12th Gen Intel(R) Core(TM) i3-1215U e 8GB de ram.
    \end{itemize}
    \begin{figure}[!htb]
    \centering
    \includegraphics[width=0.72\textwidth, height=0.55\textheight]{../../imagensEtapa2/boxplotJulia.pdf}
...
\frame{
    ...
    \begin{figure}[!htb]
    \centering
    \includegraphics[width=0.8\textwidth, height=0.65\textheight]{../../imagensEtapa2/boxplotCombinado.pdf}
