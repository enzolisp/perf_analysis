...
\begin{frame}
    ...
    \begin{block}{Aprendizado Metodológico}
        A análise de desempenho exige controle rigoroso de hardware. O uso de Mediana mostrou-se mais robusto que a Média para ignorar \textit{outliers} causados pelo Sistema Operacional.
    \end{block}
\end{frame}
