...
\frame{
    ...
    \begin{itemize}
        ...
        \item Script Makefile que orquestra todo o fluxo;
    \end{itemize}
}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/control_chart_julia_mid_1d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{1D}}
        \end{column}
        ...
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/control_chart_julia_mid_2d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{2D}}
        \end{column}
        ...
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/control_chart_julia_mid_3d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{3D}}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/control_chart_python_mid_1d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{1D}}
        \end{column}
        ...
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/control_chart_python_mid_2d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{2D}}
        \end{column}
        ...
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/control_chart_python_mid_3d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{3D}}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/boxplot_mem_1d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{1D}}
        \end{column}
        ...
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/boxplot_mem_2d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{2D}}
        \end{column}
        ...
        \begin{column}{0.33\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/boxplot_mem_3d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{3D}}
        \end{column}
    \end{columns}
...
\frame{
    ...
    \begin{figure}[!htb]
    \centering
        \includegraphics[width=0.8\textwidth]{../../imagensEtapa3/linear_regression_texec_julia_2d.pdf}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/linear_regression_texec_julia_1d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{1D}}
        \end{column}
        ...
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/linear_regression_texec_julia_3d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{3D}}
        \end{column}
...
\frame{
    ...
    \begin{figure}[!htb]
    \centering
        \includegraphics[width=0.8\textwidth]{../../imagensEtapa3/linear_regression_texec_python_2d.pdf}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/linear_regression_texec_python_1d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{1D}}
        \end{column}
        ...
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/linear_regression_texec_python_3d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{3D}}
        \end{column}
...
\frame{
    ...
    \begin{figure}[!htb]
    \centering
        \includegraphics[width=0.8\textwidth]{../../imagensEtapa3/linear_regression_mempeak_julia_2d.pdf}
        \caption{Regressão linear julia 2d}
    \end{figure}
}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/linear_regression_mempeak_julia_1d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{1D}}
        \end{column}
        ...
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/linear_regression_mempeak_julia_3d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{3D}}
        \end{column}
...
\frame{
    ...
    \begin{figure}[!htb]
    \centering
        \includegraphics[width=0.8\textwidth]{../../imagensEtapa3/linear_regression_mempeak_python_2d.pdf}
        \caption{Regressão linear python 2d}
    \end{figure}
}
...
\begin{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/linear_regression_mempeak_python_1d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{1D}}
        \end{column}
        ...
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../../imagensEtapa3/linear_regression_mempeak_python_3d.pdf}
            \vspace{0.1cm}
            {\tiny \textbf{3D}}
        \end{column}
